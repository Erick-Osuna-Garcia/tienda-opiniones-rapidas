...
export const surveyCategories: Category[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'quesos-5', text: '¿Qué tan fácil fue encontrar el tipo de queso que buscabas?' },
      { id: 'quesos-6', text: '¿Cómo calificarías la variedad de quesos disponibles?' },
      { id: 'quesos-7', text: '¿Cómo calificarías la presentación del personal en el área de quesos?' },
      { id: 'quesos-8', text: '¿Cómo calificarías la calidad de los quesos exhibidos?' }
    ]
  },
  {
